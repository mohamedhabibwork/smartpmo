            ...
            <div class="text-center mb-12">
                ...
                <section class="container mx-auto  px-6">
                    <div class="grid grid-cols-1  md:grid-cols-12 gap-6">
                        <!-- 6-column section -->
                        <div class="md:col-span-6 p-6 rounded-lg flex flex-col lg:flex-row justify-between lg:items-start bg-[#D9D9D9] mt-8">
                        ...
                        <div class="md:col-span-6 p-6 rounded-lg  items-start bg-[#D9D9D9] mt-8">
