<x-layout.app>
    ...
    <section class="relative w-full h-screen flex justify-start items-center ">
        ...
        <div class="relative z-10 text-white max-w-2xl  px-6 flex justify-start items-start flex-col ml-6">
